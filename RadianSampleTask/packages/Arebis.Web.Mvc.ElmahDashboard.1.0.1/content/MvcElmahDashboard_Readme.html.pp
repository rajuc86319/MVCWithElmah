...
<pre>    routes.MapRoute(
        ...
        <span class="marked">namespaces: new String[] { "$rootnamespace$.Controllers" }</span>
    );
</pre>
    ...
    &lt;/appSettings></pre>
      ...
      ...
    &lt;/appSettings></pre>
                    <p>To configure the Remote Address service using IPInfo.io:</p>
                    <pre>    &lt;appSettings>
      &lt;add key="MvcElmahDashboardRemoteAddressInfoProvider"
      value="<span class="marked">Caption=IPinfo.io;InfoUrl=http://ipinfo.io/;ServiceUrl=http://ipinfo.io/{value};Latitude=loc;Longitude=loc</span>" />
      ...
    &lt;/appSettings></pre>
